...
pub fn get() -> (&'static str, Theme) {
  ...
  --sidebar-primary: oklch(0.75 0.15 150);
  --sidebar-primary-foreground: oklch(0.969 0.015 12.422);
  --sidebar-accent: oklch(0.967 0.001 286.375);
  --sidebar-accent-foreground: oklch(0.21 0.006 285.885);
  --sidebar-border: oklch(0.92 0.004 286.32);
  --sidebar-ring: oklch(0.75 0.15 150);"#
                .to_string(),
            dark_content: r#"--background: oklch(0.15 0.03 150);
  --foreground: oklch(0.985 0 0);
  --card: oklch(0.2 0.02 150);
  --card-foreground: oklch(0.985 0 0);
  --popover: oklch(0.2 0.02 150);
  --popover-foreground: oklch(0.985 0 0);
  --primary: oklch(0.7 0.2 150);
  --primary-foreground: oklch(0.969 0.015 12.422);
  --secondary: oklch(0.25 0.025 150);
  --secondary-foreground: oklch(0.985 0 0);
  --muted: oklch(0.25 0.025 150);
  --muted-foreground: oklch(0.7 0.02 150);
  --accent: oklch(0.25 0.025 150);
  --accent-foreground: oklch(0.985 0 0);
  --destructive: oklch(0.704 0.191 22.216);
  --destructive-foreground: oklch(0.969 0.015 12.422);
  --border: oklch(0.25 0.015 150 / 20%);
  --input: oklch(0.25 0.015 150 / 25%);
  ...
  --sidebar-primary-foreground: oklch(0.969 0.015 12.422);
  --sidebar-accent: oklch(0.25 0.025 150);
  --sidebar-accent-foreground: oklch(0.985 0 0);
  --sidebar-border: oklch(0.25 0.015 150 / 20%);
